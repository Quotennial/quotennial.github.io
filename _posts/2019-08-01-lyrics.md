...
var chart = new CanvasJS.Chart("chartContainer", {
	...
	data: [{
		...
		dataPoints: [
			{x: 357.5098039215686, y: 784.7058823529412, z: 51 , name: "Dave"},
			{x: 245.57831325301206, y: 496.6807228915663, z: 166 , name: "Kano"},
			{x: 219.66666666666666, y: 424.9555555555556, z: 45 , name: "Loyle Carner"},
		]
	}]
});
chart.render();
